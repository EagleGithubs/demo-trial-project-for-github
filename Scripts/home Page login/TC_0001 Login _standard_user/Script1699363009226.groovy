...
WebUI.rightClick(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_login-button'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_login-button'))
